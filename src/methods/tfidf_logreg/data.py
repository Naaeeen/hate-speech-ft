...
def build_classical_data_splits(
    dataset,
    args,
    *,
    train_split: str,
    ...
    eval_data = build_classical_split(
        dataset[eval_split],
        max_samples=args.max_eval_samples,
    )
    test_data = (
        build_classical_split(dataset[test_split], max_samples=args.max_test_samples)
        if args.run_test
        else None
    )
