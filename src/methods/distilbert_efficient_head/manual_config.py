...
CONFIG = {
    ...
    # Hugging Face checkpoint. Stage 2 reloads this fresh backbone.
    ...
    "max_length": 128,
    # Stage 1 trains LoRA adapters plus the classification head.
    ...
    # Save the task head so it can be copied into the fresh stage-2 model.
    "stage1_modules_to_save": ["pre_classifier", "classifier"],
    # Stage 2 copies only the trained head, then full-fine-tunes all weights.
    ...
    # Trainer schedule for both stages. With "epoch", steps fields are backups.
    "eval_strategy": "epoch",
    "save_strategy": "epoch",
    ...
    "save_steps": 500,
    "save_total_limit": 1,
    # Pick the best checkpoint in each stage by validation macro F1.
    "load_best_model_at_end": True,
    "metric_for_best_model": "eval_f1_macro",
    "lower_is_better": False,
    # Keep False for final runs so final model/tokenizer artifacts are saved.
