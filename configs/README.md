...
For new method implementations, copy `src/methods/_template/` to a method-owned
package and reuse `src.methods.common` for the shared CLI/tracking contract
before registering the new catalog entry here.
